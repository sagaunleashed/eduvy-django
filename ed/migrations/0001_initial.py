# Generated by Django 3.0.5 on 2021-07-02 04:31
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Image', models.ImageField(blank=True, upload_to=ed.models.branch_upload, verbose_name='BranchImage')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('code', models.CharField(default='000', max_length=150, unique=True, verbose_name='Institution Code')),
                ...
                ('image', models.ImageField(default='media/logo.png', upload_to=ed.models.College.user_directory_path, verbose_name='Image')),
                ...
                ('logo', models.ImageField(default='brochure.jpg', upload_to=ed.models.College.user_directory_path)),
                ('description', models.TextField(blank=True, max_length=500, verbose_name='description')),
                ('brochure', models.ImageField(default='brochure.jpg', upload_to=ed.models.College.user_directory_path)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('CourseType', models.IntegerField(default=1, verbose_name='Course Type')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Status', models.CharField(choices=[('Active', 'Active'), ('Inactive', 'Inactive')], default='Active', max_length=50, verbose_name='Status')),
                ('cityId', models.IntegerField(default=1, verbose_name='City ID')),
                ('courseType', models.CharField(default='1', max_length=225, verbose_name='Course Type')),
                ('stateID', models.IntegerField(default=1, verbose_name='State Id')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(default='Other Fee', max_length=150, verbose_name='Fee')),
                ('value', models.IntegerField(default=0, verbose_name='fee value')),
                ('parent', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='ed.institutionCourse')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Status', models.CharField(choices=[('Active', 'Active'), ('Inactive', 'Inactive')], max_length=254, verbose_name='Status')),
                ('dateCreated', models.DateField(default=datetime.date.today, verbose_name='Date Created')),
                ('branchId', models.ForeignKey(default=1, on_delete=django.db.models.deletion.SET_DEFAULT, to='ed.Branch')),
                ('institutionId', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='ed.Institution')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('institutionCourse', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='ed.institutionCourse', verbose_name='Institution Course')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dateCreated', models.DateField(default=datetime.date.today, verbose_name='Date Created')),
                ('branchId', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='ed.Branch')),
                ('college', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='ed.College')),
                ('courseId', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='ed.Course')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='college',
            name='institution',
            field=models.ForeignKey(default=1, on_delete=django.db.models.deletion.CASCADE, to='ed.Institution'),
        ),
        migrations.AddField(
            model_name='college',
            name='user',
